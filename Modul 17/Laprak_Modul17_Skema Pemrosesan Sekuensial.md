...
2
9999
Rata-rata bilangan adalah: 1.83
PS D:\Golang SMT2>
```
### Penjelasan
...
```
PS D:\Golang SMT2> go run "d:\Golang SMT2\cok.go"
Masukan kata yang akan dicari: apel
Masukan banyak data: 5
Masukan kata ke-1: nanas
Masukan kata ke-2: jeruk
Masukan kata ke-3: apel
Masukan kata ke-4: apel
Masukan kata ke-5: mangga
Kata ditemukan pada posisi: 3, 4
Jumlah kemunculan: 2
Ada sedikitnya dua kata apel
PS D:\Golang SMT2>
```
...
```
PS D:\Golang SMT2> go run "d:\Golang SMT2\cok.go"
Masukkan jumlah tetesan air hujan: 10000000
Curah hujan daerah A: 250.163 milimeter
Curah hujan daerah B: 250.009 milimeter
Curah hujan daerah C: 249.838 milimeter
Curah hujan daerah D: 249.991 milimeter
PS D:\Golang SMT2>
```
### Penjelasan
